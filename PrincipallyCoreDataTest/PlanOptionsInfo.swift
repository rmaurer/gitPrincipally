...
class PlanOptionsInfo: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        case "Variable Interest Rate":
            infoTextView.text = "Most federal loans have a fixed interest rate.  If your loan has an interest rate of 5.4% now, it will have a rate of 5.4% for the entire life of the loan.  However, when you refinance your loans, your interest rate might become a variable interest rate. The rate might be 2.0% or 3.5% now, but the interest rate may increase over time depending on changes in the global marketplace.  Nobody can know what interest rates will look like in the future, and yours may change more frequently than annually, but this will allow you to generally understand the effect of a variable interest rate."
        case "Variable Interest Rate":
        ...
        case "Years In Program":
            infoTextView.text = "Under this repayment option, you are expecting to be in an income-driven repayment plan for a set number of years.  Afterwards, the program assumes that you return to the Standard (10-year) repayment plan.  Use this option to let the estimator know whether you are planning to be in income-driven repayment for 1 year, 2 years, 3 years or more.  Remember, the longer you stay in an income-driven plan, the higher your payments will be for the remainder of the 10 years."
